...
public class Length extends BaseTest implements SRIS_TestData
{
	...
	@Test(priority = 2)
	public void CheckLengthShouldNotMoreThan50ForWorkingStatusName()throws InterruptedException
	{
		SRIS_MasterModule masterdata = new SRIS_MasterModule(driver);
		Thread.sleep(700);
		masterdata.WorkingStatusNameClearMethod();
		Thread.sleep(700);
		masterdata.WorkingStatusNameLengthMoreThan50Method();
		Thread.sleep(700);
	...
	@Test(priority = 3)
	public void CheckLengthShouldNotMoreThan200ForWorkingStatusDescription()throws InterruptedException
	{
		SRIS_MasterModule masterdata = new SRIS_MasterModule(driver);
		Thread.sleep(700);
		masterdata.WorkingStatusDescriptionClearMethod();
		Thread.sleep(700);
		masterdata.WorkingStatusDescriptionLengthMoreThan200Method();
		Thread.sleep(700);
