...
public class SpecialChar extends BaseTest implements SRIS_TestData
{
	...
	@Test(priority = 2)
	public void CkeckSpecialCharForFloorMaterialName()throws InterruptedException
	{
		SRIS_MasterModule masterdata = new SRIS_MasterModule(driver);
		Thread.sleep(700);
		...
		if (constainsSpecial == true) {
			AutoConstant.fileone.setCellData(FloorMaterial_Sheet, Column_name, 10, "Fail");
			System.out.println("Fail");
		} 
		else {
			AutoConstant.fileone.setCellData(FloorMaterial_Sheet, Column_name, 10, "Pass");
