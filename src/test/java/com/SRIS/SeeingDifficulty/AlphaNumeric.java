...
public class AlphaNumeric extends BaseTest implements SRIS_TestData
{
	...
	@Test(priority = 2)
	public void CheckAlphaNumericForSeeingDifficultyName()throws InterruptedException
	{
		SRIS_MasterModule masterdata = new SRIS_MasterModule(driver);
		Thread.sleep(700);
		masterdata.SeeingDifficultyClearMethod();
		Thread.sleep(700);
		masterdata.SeeingDifficultyAlphaNumericMethod();
		Thread.sleep(700);
		...
		if (constainsSpecial == true) {
			AutoConstant.fileone.setCellData(SeeingDifficulty_Sheet, Column_name, 17, "Fail");
			System.out.println("Fail");
		} 
		else {
			AutoConstant.fileone.setCellData(SeeingDifficulty_Sheet, Column_name, 17, "Pass");
			System.out.println("Pass");
		}
	}
	
	@Test(priority = 3)
	public void CheckAlphaNumericForSeeingDifficultyDescription()throws InterruptedException
	{
		SRIS_MasterModule masterdata = new SRIS_MasterModule(driver);
		Thread.sleep(700);
		masterdata.SeeingDifficultyDescriptionClearMethod();
		Thread.sleep(700);
		masterdata.SeeingDifficultyDescriptionAlphaNumericMethod();
		Thread.sleep(700);
		...
		boolean constainsSpecial = matcher.find();
		if (constainsSpecial == true) {
			AutoConstant.fileone.setCellData(SeeingDifficulty_Sheet, Column_name, 18, "Fail");
			System.out.println("Fail");
		} 
		else {
			AutoConstant.fileone.setCellData(SeeingDifficulty_Sheet, Column_name, 18, "Pass");
			System.out.println("Pass");
		}
	}
	@Test(priority = 4)
	public void CheckAlphabetsForSeeingDifficultyName()throws InterruptedException
	{
		SRIS_MasterModule masterdata = new SRIS_MasterModule(driver);
		Thread.sleep(700);
		masterdata.SeeingDifficultyClearMethod();
	...
	@Test(priority = 5)
	public void CheckAlphabetsForSeeingDifficultyDescription()throws InterruptedException
	{
		SRIS_MasterModule masterdata = new SRIS_MasterModule(driver);
		Thread.sleep(700);
		//masterdata.AddMethod();
