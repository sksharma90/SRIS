...
public class Length extends BaseTest implements SRIS_TestData
{
	...
	@Test(priority = 2)
	public void CheckLengthShouldNotMoreThan50ForOrganizatonTypeName()throws InterruptedException
	{
		SRIS_MasterModule masterdata = new SRIS_MasterModule(driver);
		Thread.sleep(700);
		masterdata.OrganizatonTypeNameClearMethod();
		Thread.sleep(700);
		masterdata.OrganizatonTypeNameLengthMoreThan50Method();
		Thread.sleep(700);
	...
	@Test(priority = 3)
	public void CheckLengthShouldNotMoreThan200ForOrganizatonTypeDescription()throws InterruptedException
	{
		SRIS_MasterModule masterdata = new SRIS_MasterModule(driver);
		Thread.sleep(700);
		masterdata.OrganizatonTypeDescriptionClearMethod();
		Thread.sleep(700);
		masterdata.OrganizatonTypeDescriptionLengthMoreThan200Method();
		Thread.sleep(700);
