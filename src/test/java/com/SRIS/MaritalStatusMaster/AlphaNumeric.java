...
public class AlphaNumeric extends BaseTest implements SRIS_TestData
{
	...
	@Test(priority = 2)
	public void CheckAlphaNumericForMaritalStatusName()throws InterruptedException
	{
		SRIS_MasterModule masterdata = new SRIS_MasterModule(driver);
		Thread.sleep(700);
		masterdata.MaritalStatusNameClearMethod();
		Thread.sleep(700);
		masterdata.MaritalStatusNameAlphaNumericMethod();
		Thread.sleep(700);
		...
		if (constainsSpecial == true) {
			AutoConstant.fileone.setCellData(MaritalStatusMaster_Sheet, Column_name, 11, "Fail");
			System.out.println("Fail");
		} 
		else {
			AutoConstant.fileone.setCellData(MaritalStatusMaster_Sheet, Column_name, 11, "Pass");
			System.out.println("Pass");
		}
	}
	@Test(priority = 3)
	public void CheckAlphabetsForMaritalStatusName()throws InterruptedException
	{
		SRIS_MasterModule masterdata = new SRIS_MasterModule(driver);
		Thread.sleep(700);
		masterdata.MaritalStatusNameClearMethod();
