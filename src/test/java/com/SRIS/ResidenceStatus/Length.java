...
public class Length extends BaseTest implements SRIS_TestData
{
	...
	@Test(priority = 2)
	public void CheckLengthShouldNotMoreThan50ForResidenceName()throws InterruptedException
	{
		SRIS_MasterModule masterdata = new SRIS_MasterModule(driver);
		Thread.sleep(700);
		masterdata.ResidenceNameClearMethod();
		Thread.sleep(700);
		masterdata.ResidenceNameLengthMoreThan50Method();
		Thread.sleep(700);
	...
	@Test(priority = 3)
	public void CheckLengthShouldNotMoreThan200ForResidenceDescription()throws InterruptedException
	{
		SRIS_MasterModule masterdata = new SRIS_MasterModule(driver);
		Thread.sleep(700);
		masterdata.ResidenceDescriptionClearMethod();
		Thread.sleep(700);
		masterdata.ResidenceDescriptionLengthMoreThan200Method();
		Thread.sleep(700);
