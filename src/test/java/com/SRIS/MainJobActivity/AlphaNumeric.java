...
public class AlphaNumeric extends BaseTest implements SRIS_TestData
{
	...
	@Test(priority = 2)
	public void CheckAlphaNumericForMainJobActivityName()throws InterruptedException
	{
		SRIS_MasterModule masterdata = new SRIS_MasterModule(driver);
		Thread.sleep(700);
		masterdata.MainJobActivityNameClearMethod();
		Thread.sleep(700);
		masterdata.MainJobActivityNameAlphaNumericMethod();
		Thread.sleep(700);
		...
		if (constainsSpecial == true) {
			AutoConstant.fileone.setCellData(MainJobActivity_Sheet, Column_name, 17, "Fail");
			System.out.println("Fail");
		} 
		else {
			AutoConstant.fileone.setCellData(MainJobActivity_Sheet, Column_name, 17, "Pass");
			System.out.println("Pass");
		}
	}
	
	@Test(priority = 3)
	public void CheckAlphaNumericForMainJobActivityDescription()throws InterruptedException
	{
		SRIS_MasterModule masterdata = new SRIS_MasterModule(driver);
		Thread.sleep(700);
		masterdata.MainJobActivityDescriptionClearMethod();
		Thread.sleep(700);
		masterdata.MainJobActivityDescriptionAlphaNumericMethod();
		Thread.sleep(700);
		...
		boolean constainsSpecial = matcher.find();
		if (constainsSpecial == true) {
			AutoConstant.fileone.setCellData(MainJobActivity_Sheet, Column_name, 18, "Fail");
			System.out.println("Fail");
		} 
		else {
			AutoConstant.fileone.setCellData(MainJobActivity_Sheet, Column_name, 18, "Pass");
			System.out.println("Pass");
		}
	}
	@Test(priority = 4)
	public void CheckAlphabetsForMainJobActivityName()throws InterruptedException
	{
		SRIS_MasterModule masterdata = new SRIS_MasterModule(driver);
		Thread.sleep(700);
		masterdata.MainJobActivityNameClearMethod();
	...
	@Test(priority = 5)
	public void CheckAlphabetsForMainJobActivityDescription()throws InterruptedException
	{
		SRIS_MasterModule masterdata = new SRIS_MasterModule(driver);
		Thread.sleep(700);
		//masterdata.AddMethod();
