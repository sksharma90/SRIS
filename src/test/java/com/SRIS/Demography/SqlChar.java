...
public class SqlChar extends BaseTest implements SRIS_TestData
{
	...
	public void CkeckSpecialCharForLocationName()throws InterruptedException
	{
		...
		if (constainsSpecial == true) {
			AutoConstant.fileone.setCellData(Demography_Sheet, Column_name, 17, "Fail");
			System.out.println("Fail");
		} 
		else {
			AutoConstant.fileone.setCellData(Demography_Sheet, Column_name, 17, "Pass");
	...
	public void CkeckSpecialCharForLocationDesc()throws InterruptedException
	{
		...
		Thread.sleep(700);
		masterdata.LocationDescriptionSQLCharMethod();
		Thread.sleep(700);
		...
		boolean constainsSpecial = matcher.find();
		if (constainsSpecial == true) {
			AutoConstant.fileone.setCellData(Demography_Sheet, Column_name, 18, "Fail");
			System.out.println("Fail");
		} 
		else {
			AutoConstant.fileone.setCellData(Demography_Sheet, Column_name, 18, "Pass");
			System.out.println("Pass");
		}
	}
}
