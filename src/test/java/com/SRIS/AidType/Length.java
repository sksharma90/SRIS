...
public class Length extends BaseTest implements SRIS_TestData
{
	...
	@Test(priority = 2)
	public void CheckLengthShouldNotMoreThan50ForAidType()throws InterruptedException
	{
		SRIS_MasterModule masterdata = new SRIS_MasterModule(driver);
		Thread.sleep(700);
		masterdata.AidTypeClearMethod();
		Thread.sleep(700);
		masterdata.AidTypeLengthMoreThan50Method();
		Thread.sleep(700);
	...
	@Test(priority = 3)
	public void CheckLengthShouldNotMoreThan200ForAidTypeDescription()throws InterruptedException
	{
		SRIS_MasterModule masterdata = new SRIS_MasterModule(driver);
		Thread.sleep(700);
		masterdata.AidTypeDescriptionClearMethod();
		Thread.sleep(700);
		masterdata.AidTypeDescriptionLengthMoreThan200Method();
		Thread.sleep(700);
