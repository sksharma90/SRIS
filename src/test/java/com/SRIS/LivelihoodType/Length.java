...
public class Length extends BaseTest implements SRIS_TestData
{
	...
	@Test(priority = 2)
	public void CheckLengthShouldNotMoreThan50ForLivelihoodType()throws InterruptedException
	{
		SRIS_MasterModule masterdata = new SRIS_MasterModule(driver);
		Thread.sleep(700);
		masterdata.LivelihoodTypeClearMethod();
		Thread.sleep(700);
		masterdata.LivelihoodTypeLengthMoreThan50Method();
		Thread.sleep(700);
	...
	@Test(priority = 3)
	public void CheckLengthShouldNotMoreThan200ForLivelihoodTypeDescription()throws InterruptedException
	{
		SRIS_MasterModule masterdata = new SRIS_MasterModule(driver);
		Thread.sleep(700);
		masterdata.LivelihoodTypeDescriptionClearMethod();
		Thread.sleep(700);
		masterdata.LivelihoodTypeDescriptionLengthMoreThan200Method();
		Thread.sleep(700);
