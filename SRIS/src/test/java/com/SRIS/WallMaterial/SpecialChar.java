...
public class SpecialChar extends BaseTest implements SRIS_TestData
{
	...
	@Test(priority = 2)
	public void CkeckSpecialCharForWallMaterialName()throws InterruptedException
	{
		SRIS_MasterModule masterdata = new SRIS_MasterModule(driver);
		Thread.sleep(700);
		...
		Thread.sleep(700);
		masterdata.WallMaterialNameSpecialCharMethod();
		Thread.sleep(700);
		...
		if (constainsSpecial == true) {
			AutoConstant.fileone.setCellData(WallMaterial_Sheet, Column_name, 10, "Fail");
			System.out.println("Fail");
		} 
		else {
			AutoConstant.fileone.setCellData(WallMaterial_Sheet, Column_name, 10, "Pass");
