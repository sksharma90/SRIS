...
public class Length extends BaseTest implements SRIS_TestData
{
	...
	@Test(priority = 2)
	public void CheckLengthShouldNotMoreThan50ForMainDrinkingSource()throws InterruptedException
	{
		SRIS_MasterModule masterdata = new SRIS_MasterModule(driver);
		Thread.sleep(700);
		masterdata.MainDrinkingSourceClearMethod();
		Thread.sleep(700);
		masterdata.MainDrinkingSourceLengthMoreThan50Method();
		Thread.sleep(700);
	...
	@Test(priority = 3)
	public void CheckLengthShouldNotMoreThan200ForMainDrinkingSourceDescription()throws InterruptedException
	{
		SRIS_MasterModule masterdata = new SRIS_MasterModule(driver);
		Thread.sleep(700);
		masterdata.MainDrinkingSourceDescriptionClearMethod();
		Thread.sleep(700);
		masterdata.MainDrinkingSourceDescriptionLengthMoreThan200Method();
		Thread.sleep(700);
