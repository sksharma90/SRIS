...
public class Duplicate extends BaseTest implements SRIS_TestData
{
	...
	public void CheckDuplicateAllowForDescription()throws InterruptedException
	{
		...
		Thread.sleep(700);
		masterdata.NationalityNameUniqueMethod();
		Thread.sleep(700);
	...
	@Test(priority = 3)
	public void CheckDuplicateNotAllowForNationalityName()throws InterruptedException
	{
		SRIS_MasterModule masterdata = new SRIS_MasterModule(driver);
		Thread.sleep(1000);
		masterdata.AddMethod();
		...
		Thread.sleep(700);
		masterdata.NationalityNameDuplicateMethod();
		Thread.sleep(700);
		masterdata.NationalityDifferentDescriptionMethod();
		Thread.sleep(700);
		masterdata.SubmitButtonMethod();
		Thread.sleep(700);
		masterdata.PopupYesMethod();
		...
		if(msg.equalsIgnoreCase("Duplicate Record Exists!!"))
		{
			System.out.println(msg);
			masterdata.PopupOkMethod();
			AutoConstant.fileone.setCellData(Nationality_Sheet, "Status", 25, "Pass");
		}
		else
		{
			System.out.println("Validation Message Not Showing");
			AutoConstant.fileone.setCellData(Nationality_Sheet, "Status", 25, "Fail");
		}
	}
}
