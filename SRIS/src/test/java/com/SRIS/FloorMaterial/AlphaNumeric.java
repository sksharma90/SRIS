...
public class AlphaNumeric extends BaseTest implements SRIS_TestData
{
	...
	@Test(priority = 2)
	public void CheckAlphaNumericForFloorMaterialName()throws InterruptedException
	{
		SRIS_MasterModule masterdata = new SRIS_MasterModule(driver);
		Thread.sleep(700);
		...
		Thread.sleep(700);
		masterdata.FloorMaterialNameAlphaNumericMethod();
		Thread.sleep(700);
		...
		if (constainsSpecial == false) {
			AutoConstant.fileone.setCellData(FloorMaterial_Sheet, Column_name, 12, "Pass");
			System.out.println("Pass");
		} 
		else {
			AutoConstant.fileone.setCellData(FloorMaterial_Sheet, Column_name, 12, "Fail");
			System.out.println("Fail");
		}
	}
	@Test(priority = 3)
	public void CheckAlphabetsForFloorMaterialName()throws InterruptedException
	{
		SRIS_MasterModule masterdata = new SRIS_MasterModule(driver);
		Thread.sleep(700);
		masterdata.FloorMaterialCategoryMethod();
